...
ALTER TABLE "public"."advanced_automations" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."messages" (
    ...
    "cc_email" "public"."citext"[],
    "bcc_email" "public"."citext"[],
    "metadata" "jsonb" DEFAULT '{}'::"jsonb" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"()
);
...
ALTER TABLE ONLY "public"."advanced_automations"
    ADD CONSTRAINT "advanced_automations_pkey" PRIMARY KEY ("id");
...
CREATE OR REPLACE TRIGGER "tr_advanced_automations_update" BEFORE UPDATE ON "public"."advanced_automations" FOR EACH ROW EXECUTE FUNCTION "public"."fn_auto_update_timestamp"();
...
CREATE OR REPLACE TRIGGER "tr_email_usage_update" BEFORE UPDATE ON "public"."email_usage" FOR EACH ROW EXECUTE FUNCTION "public"."fn_auto_update_timestamp"();
...
CREATE OR REPLACE TRIGGER "tr_notifications_update" BEFORE UPDATE ON "public"."notifications" FOR EACH ROW EXECUTE FUNCTION "public"."fn_auto_update_timestamp"();
...
CREATE OR REPLACE TRIGGER "tr_reports_update" BEFORE UPDATE ON "public"."reports" FOR EACH ROW EXECUTE FUNCTION "public"."fn_auto_update_timestamp"();
...
CREATE OR REPLACE TRIGGER "tr_tags_update" BEFORE UPDATE ON "public"."tags" FOR EACH ROW EXECUTE FUNCTION "public"."fn_auto_update_timestamp"();
...
ALTER TABLE ONLY "public"."advanced_automations"
    ADD CONSTRAINT "advanced_automations_org_id_fkey" FOREIGN KEY ("org_id") REFERENCES "public"."organizations"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."automation_actions"
    ADD CONSTRAINT "automation_actions_automation_id_fkey" FOREIGN KEY ("automation_id") REFERENCES "public"."advanced_automations"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."automation_conditions"
    ADD CONSTRAINT "automation_conditions_automation_id_fkey" FOREIGN KEY ("automation_id") REFERENCES "public"."advanced_automations"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."automation_logs"
    ADD CONSTRAINT "automation_logs_automation_id_fkey" FOREIGN KEY ("automation_id") REFERENCES "public"."advanced_automations"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."knowledge_doc_categories"
    ADD CONSTRAINT "knowledge_doc_categories_parent_id_fkey" FOREIGN KEY ("parent_id") REFERENCES "public"."knowledge_doc_categories"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."knowledge_docs"
    ADD CONSTRAINT "knowledge_docs_author_id_fkey" FOREIGN KEY ("author_id") REFERENCES "public"."users"("id") ON DELETE SET NULL;
...
GRANT ALL ON TABLE "public"."advanced_automations" TO "anon";
GRANT ALL ON TABLE "public"."advanced_automations" TO "authenticated";
GRANT ALL ON TABLE "public"."advanced_automations" TO "service_role";
